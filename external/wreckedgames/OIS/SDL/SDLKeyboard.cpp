    ...
    : Keyboard(creator->inputSystemName(), buffered, 0, creator)
{
    ...
    mKeyMap.insert( KeyMap::value_type(SDLK_NUMLOCKCLEAR, KC_NUMLOCK) );
    mKeyMap.insert( KeyMap::value_type(SDLK_SCROLLLOCK, KC_SCROLL));
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_7, KC_NUMPAD7) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_8, KC_NUMPAD8) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_9, KC_NUMPAD9) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_4, KC_NUMPAD4) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_5, KC_NUMPAD5) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_6, KC_NUMPAD6) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_1, KC_NUMPAD1) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_2, KC_NUMPAD2) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_3, KC_NUMPAD3) );
    mKeyMap.insert( KeyMap::value_type(SDLK_KP_0, KC_NUMPAD0) );
#else
...
#if SDL_VERSION_ATLEAST(2,0,0)
    mKeyMap.insert( KeyMap::value_type(SDLK_LGUI, KC_LWIN) );
    mKeyMap.insert( KeyMap::value_type(SDLK_RGUI, KC_RWIN) );
#else
...
void SDLKeyboard::capture()
{
    ...
    int count = SDL_PeepEvents(events, OIS_SDL_KEY_BUFF, SDL_GETEVENT, 
        SDL_KEYDOWN | SDL_KEYUP, SDL_KEYDOWN | SDL_KEYUP);
#else
    int count = SDL_PeepEvents(events, OIS_SDL_KEY_BUFF, SDL_GETEVENT, 
...
//-------------------------------------------------------------------//
#if SDL_VERSION_ATLEAST(2,0,0)
bool SDLKeyboard::_injectKeyDown( SDL_Keycode key, int text )
#else
...
//-------------------------------------------------------------------//
#if SDL_VERSION_ATLEAST(2,0,0)
bool SDLKeyboard::_injectKeyUp( SDL_Keycode key )
#else
